<template>
<div class="outerbox">
    <myHeader title="编辑项目" leftIcon="back"></myHeader>  
    <mt-field label="项目名称" placeholder="请输入用户名" v-model="title" id="top"></mt-field>
    ...
    <mt-field label="参与成员" type="textarea" rows="3">
        ...
        <div class="group"><img src="../assets/headshot.jpg"><div class="name">雪莹</div></div>
        <div class="group">
            <router-link :to="{name:'addmember',params:{ proId:item.id}}">
                <img src="../assets/add.png">
            </router-link>
            <div class="name">&nbsp;</div>
        </div>      
...
export default {
    components: {myHeader,DatetimePicker},
    data(){
        return{
            item:{},
            now:0,
